...
const SUBSCRIBE_EMAIL = "kareemkhamis2030@gmail.com";
...
const Footer = () => {
  ...
  const handleSubscribe = (e) => {
    ...
    const body = encodeURIComponent(
      `Please add this email to your newsletter: ${email}`
    );
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        <div className="max-w-md mx-auto mb-12">
          <form onSubmit={handleSubscribe} className="flex gap-2">
            ...
            <button
              type="submit"
              className="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-sm font-light text-sm uppercase tracking-wide transition-all duration-300 border border-white/10"
            >
              Subscribe
            </button>
          </form>
