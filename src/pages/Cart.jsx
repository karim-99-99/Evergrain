                    ...
                    <div className="flex-1 flex flex-col md:flex-row justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1 mb-3">
                          ...
                          <span className="text-sm text-[#5C4A37] ml-2">(17)</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                        <div className="text-right">
                          <p className="text-2xl font-bold text-[#332B2B]">{item.price}</p>
                        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#332B2B] font-medium">Free Shipping on Orders Over $100</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-[#5C4A37] rounded-full flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
